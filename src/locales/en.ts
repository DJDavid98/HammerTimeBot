...
export const locale: Localization = {
  commands: {
    timestamp: {
      ...
      options: {
        year: { name: 'year', description: 'Specify the year (defaults to current year)' },
        month: { name: 'month', description: 'Specify the month (defaults to current month)' },
        day: { name: 'day', description: 'Specify the day (defaults to current day)' },
        hour: { name: 'hour', description: 'Specify the hour (defaults to current hour)' },
        minute: { name: 'minute', description: 'Specify the minute (defaults to current minute)' },
        second: { name: 'second', description: 'Specify the second (defaults to 0)' },
        timezone: { name: 'timezone', description: 'Specify the timezone (defaults to GMT)' },
        format: {
          name: 'format',
