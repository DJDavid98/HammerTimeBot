...
export const isKnownMessageContextmenuInteraction = <InteractionType extends ContextMenuCommandInteraction>(interaction: InteractionType): interaction is InteractionType & { commandName: BotMessageContextMenuCommandName } => isKnownMessageContextMenuCommand(interaction.commandName);
